...
<div class="mainwrapper">
    <div class="header">
        ...
        <span class="header_span"><h1>Загрузка документов</h1></span>
        <span id="actsTab" class="header_span menu_span">Акты</span>
        <span id="docTab" class="header_span menu_span">Формирование<br/>документов</span>
    </div>
    <div class="leftPanel">
        <form id="upload_form" enctype="multipart/form-data">
            <div id="form_div">
                <select name="documentType" id="select_doc" class="select_option input_elem">
                    <option value="C4Faktur" selected>Счет-фактура</option>
